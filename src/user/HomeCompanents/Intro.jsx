...
function Intro() {
        ...
        return (
                <div className=''>
                        <center><Typography variant='h3' style={style.homeIntro} > Welcome to Flight reservation system</Typography>
                                <Typography variant='body1' style={style.introText} fontSize={20}>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui dolor esse tempora dicta nobis, magni labore officiis in ullam non dolore similique ducimus nihil blanditiis tempore animi. Mollitia, laudantium maxime?
